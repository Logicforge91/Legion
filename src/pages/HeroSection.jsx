...
export default function HeroSection() {
  ...
  return <section id="hero" className="hero-section" aria-labelledby="heroTitle"><div className="site-container hero-grid">
    <Reveal className="hero-copy"><p className="eyebrow"><span />Backend systems engineered for scale</p><h1 id="heroTitle">Backend developer crafting <span className="hero-title-accent">reliable systems</span> with Laravel and Java.</h1><p className="hero-lede">I turn complex requirements into secure APIs, fast data flows, and production-ready platforms. Five years of hands-on delivery across Laravel, MySQL, integrations, and growing Java/Spring Boot systems.</p><div className="hero-terminal-line" aria-live="polite"><span className="prompt">$</span><span>{typedText}</span></div><div className="hero-actions"><a href="#projects" className="btn btn-primary">Explore systems</a><a href="/assets/resume.pdf" className="btn btn-ghost" target="_blank" rel="noreferrer" download>Download resume</a><ShareProfileButton /></div><div className="hero-meta" aria-label="Current availability"><span className="hero-meta-item"><span className="hero-meta-dot" />Available for backend roles</span><span className="hero-meta-item"><i className="bi bi-geo-alt" aria-hidden="true" />Bengaluru, India</span></div><div className="hero-social" aria-label="Social links"><a href="https://github.com/Logicforge91" target="_blank" rel="noreferrer" aria-label="GitHub profile"><i className="bi bi-github" /></a><a href="https://www.linkedin.com/in/suman-k-s-a55868184/" target="_blank" rel="noreferrer" aria-label="LinkedIn profile"><i className="bi bi-linkedin" /></a><a href="mailto:Logicforge91@gmail.com" aria-label="Send email"><i className="bi bi-envelope" /></a></div></Reveal>
