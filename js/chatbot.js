    ...
    .then(html => {
      ...
      function addMessage(msg, isUser = true) {
        ...
        div.className = `p-2 rounded-3 shadow-sm mb-2 ${isUser 
          ? "bg-primary text-white ms-auto text-end d-inline-block" 
          : "bg-light text-dark me-auto text-start d-inline-block"}`;
      ...
      function showTyping() {
        ...
        typingDiv.id = "typing";
        typingDiv.className = "p-2 rounded-3 bg-secondary text-white fst-italic small me-auto mb-2 d-inline-block";
