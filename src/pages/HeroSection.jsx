...
export default function HeroSection() {
  ...
  return <section id="hero" className="hero-section" aria-labelledby="heroTitle"><div className="site-container hero-grid">
    <Reveal className="hero-copy"><p className="eyebrow"><span />Backend engineering beyond the happy path</p><h1 id="heroTitle">I build the backend layer that <span className="hero-title-accent">keeps products moving.</span></h1><p className="hero-lede">Laravel-first and production-shaped: I translate business rules into APIs, data models, integrations, and operational workflows that remain understandable when traffic, failures, and change arrive.</p><div className="hero-terminal-line"><span className="visually-hidden">{roleText}</span><span aria-hidden="true"><span className="prompt">$</span>{typedText}</span></div><div className="hero-actions"><a href="#projects" className="btn btn-primary">Explore systems</a><a href="/assets/resume.pdf" className="btn btn-ghost" download>Download resume</a><ShareProfileButton /></div><div className="hero-meta" aria-label="Current availability"><span className="hero-meta-item"><span className="hero-meta-dot" />Available for backend roles</span><span className="hero-meta-item"><i className="bi bi-geo-alt" aria-hidden="true" />Bengaluru, India</span></div><div className="hero-social" aria-label="Social links"><a href="https://github.com/Logicforge91" target="_blank" rel="noreferrer" aria-label="GitHub profile"><i className="bi bi-github" aria-hidden="true" /></a><a href="https://www.linkedin.com/in/suman-k-s-a55868184/" target="_blank" rel="noreferrer" aria-label="LinkedIn profile"><i className="bi bi-linkedin" aria-hidden="true" /></a><a href="mailto:sumanks1307@gmail.com" aria-label="Send email"><i className="bi bi-envelope" aria-hidden="true" /></a></div></Reveal>
