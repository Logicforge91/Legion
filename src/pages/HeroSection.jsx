...
export default function HeroSection() {
  ...
  return <section id="hero" className="hero-section" aria-labelledby="heroTitle"><div className="site-container hero-grid">
    <Reveal className="hero-copy"><p className="eyebrow"><span />{roleText}</p><h1 id="heroTitle">Backend developer focused on Laravel, PHP, Java, and reliable APIs.</h1><p className="hero-lede">I am Suman K S, a Backend Developer with strong PHP Laravel experience and growing Java backend depth through Spring Boot. I build REST APIs, MySQL-backed platforms, integrations, queues, and production-ready backend features.</p><div className="hero-terminal-line" aria-live="polite"><span className="prompt">$</span><span>{typedText}</span></div><div className="hero-actions"><a href="#projects" className="btn btn-primary">Explore systems</a><a href="/assets/resume.pdf" className="btn btn-ghost" target="_blank" rel="noreferrer" download>Download resume</a></div><div className="hero-social" aria-label="Social links"><a href="https://github.com/backendlegion91" target="_blank" rel="noreferrer" aria-label="GitHub profile"><i className="bi bi-github" /></a><a href="https://www.linkedin.com/in/suman-k-s-a55868184/" target="_blank" rel="noreferrer" aria-label="LinkedIn profile"><i className="bi bi-linkedin" /></a><a href="mailto:backendlegion91@gmail.com" aria-label="Send email"><i className="bi bi-envelope" /></a></div></Reveal>
